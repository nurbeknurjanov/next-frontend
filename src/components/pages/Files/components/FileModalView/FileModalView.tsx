...
import { useFileModel } from '../useFileModel';
...
export const FileModalView: FC<IProps> = ({ onClose, id }) => {
  const tc = useTranslations('Common');
  const tp = useTranslations('FilePage');
  const tm = useTranslations('File');
  const { model, getFileState } = useFileModel({
    id,
  });
